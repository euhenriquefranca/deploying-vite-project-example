    ...
    <body className='Color'>
     ...
     <h1>Isaac Moretão</h1>
      ...
      <div className='MaisSobre'>
        ...
        <Usados
        Name={'Programação'}
        text={'Expecialização: ReactJS  '}
        br={<br />}
        textDois={'Objetivo: Engressar no mercado de programadores atraves do front-End'}
        margin={'150px'}/>
        <Usados
        Name={'Isaac'}
        text={'idade: 17'}
        textDois={'Cidade: Arujá-SP'}
        margin={'0'}/>
        <Usados
        Name={'Work'}
        text={'Trabalho como freelancer junto com "Caio Cezar", fazendo o front-END'}
        margin={'150px'}/>
